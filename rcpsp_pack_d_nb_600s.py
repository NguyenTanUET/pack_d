...
def main():
    ...
    output_file = result_dir / "pack_d_with_bound_600s.csv"
    ...
    local_path = "result/pack_d_with_bound_600s.csv"
    blob_name = f"results/{os.path.basename(local_path)}"  # ví dụ "results/pack_d_with_bound_600s.csv"
